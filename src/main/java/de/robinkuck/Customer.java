...
class Customer {
    ...
    public String statement() {
        ...
        String result = "Rentals for " + this.getName() + "\n";
        result += "\t" + "Title" + "\t" + "\t" + "Days" + "\t" + "Amount" + "\n";

        while (enum_rentals.hasMoreElements()) {
            Rental each = (Rental) enum_rentals.nextElement();
            //show figures for this rental
            result += "\t" + each.getMovie().getTitle() + "\t" + "\t" + each.getDaysRented() + "\t" + each.getMovie().getPrice().getCharge(each.getDaysRented()) + "\n";
        }
        //add footer lines
    ...
    public String htmlStatement() {
        ...
        while (rentals.hasMoreElements()) {
            ...
            result += each.getMovie().getTitle() + ": " + each.getMovie().getPrice().getCharge(each.getDaysRented()) + "<BR>\n";
        }
